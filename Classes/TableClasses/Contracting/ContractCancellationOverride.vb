...
Public Class ContractCancellationOverride
    ...
    Public Shared Function AddDates(ByVal iContractID As Integer, _
        ...
        If oReturn.Success Then
            ...
            ElseIf dStartDate < dStayStartDate OrElse dEndDate > dStayEndDate Then
                oReturn.AddWarning("The Cancellation Dates must be within the Contract Stay Dates")
            End If
        End If

        'do the bizzo
        If oReturn.Success Then
            oReturn.Result = SQL.Execute("exec ContractCancellationOverrideAdd {0}, {1}, {2}", _
    ...
    Public Shared Function CheckNoOverlappingDates(ByVal iContractID As Integer, _
        ...
        Return SQL.ExecuteSingleValue("exec ContractCancellationOverrideCheckForOverlap {0},{1},{2}", _
            iContractID, SQL.GetSqlValue(dStartDate, SQL.SqlValueType.Date), _
            SQL.GetSqlValue(dEndDate, SQL.SqlValueType.Date)) = 0

    End Function

    Public Shared Sub Delete(ByVal iContractCancellationOverrideID As Integer)

        SQL.Execute("exec ContractCancellationDelete {0}", iContractCancellationOverrideID)
