...
Public Class LocationPackagePaymentTerm

    Public Shared Function AddEntries(ByVal ilocationPackageID As Integer, _
    ByVal iLocationPackagePaymentTermOverrideID As Integer, ByVal aGridData As ArrayList) _
        As FunctionReturn
        ...
        If oReturn.Success Then
            ...
            Dim iID As Integer
            If iLocationPackagePaymentTermOverrideID < 1 Then
                sTable = "LocationPackagePaymentTerm"
                sIDField = "locationPackageID"
                iID = ilocationPackageID
            Else
                sTable = "LocationpackagePaymentTermOverrideDef"
                sIDField = "LocationPackagePaymentTermOverrideID"
                iID = iLocationPackagePaymentTermOverrideID
            End If
