...
Public Class BookingSourcePaymentTermOverride
...
#Region "Add Dates"
    ...
    Public Shared Function AddDates(ByVal iBookingSourceID As Integer, _
        ...
        If oReturn.Success Then
            ...
            oReturn.Result = SQL.Execute("exec BookingSourcePaymentTermOverrideAdd {0}, {1}, {2}", _
...
#Region "Check No Overlapping Dates"
    ...
    Public Shared Function CheckNoOverlappingDates(ByVal iBookingSourceID As Integer, _
        ...
        Return SQL.ExecuteSingleValue("exec BookingSourcePaymentTermOverrideCheckForOverlap {0},{1},{2}", _
            iBookingSourceID, SQL.GetSqlValue(dStartDate, SQL.SqlValueType.Date), _
